...
% load src data
nRuns_src    = 3;
data_path = [subFolder 'myodata_' participant timeStamp '_'];
[X_src, Y_src, fold_idxs_src] = read_cut_emg_data(data_path, nRuns_src, model, 'src', woSteps, cutSequences, nMovesPerSeq);
