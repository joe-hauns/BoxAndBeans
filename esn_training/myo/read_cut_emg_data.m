function [X, Y, fold_idxs_src] = read_cut_emg_data(name, left_or_right, date, nRuns, model, woSteps, cutSequences, nMovesPerSeq)
	...
	for r = dataSets;
			...
			file = data_file(name, left_or_right, date, r);
			dataSrc = load(file, 'X_logVar', 'targets');
